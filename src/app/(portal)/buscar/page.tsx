  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 text-gray-500"><i className="fas fa-magnifying-glass text-3xl text-gray-300 mb-3" /><p className="text-sm">Nenhum serviço encontrado.</p></div>
      ) : (
        <>
